 ...
 */
void
dispatcher::thread_pool::wait_for_task()
{
        while (true)
        {
...
void
dispatcher::thread_pool::queue_job(const std::function<void()>& job)
{
...
void
dispatcher::thread_pool::terminate()
{
...
bool
dispatcher::thread_pool::busy_wait()
{
